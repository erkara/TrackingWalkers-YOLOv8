...
class Colors:
    ...
    def __init__(self):
        ...
        hexs = ('00FF00','FF3838', 'FF9D97', 'FF701F', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                ...
                #cv2.rectangle(self.im, p1, p2, color, self.lw, cv2.LINE_AA)  # filled
                cv2.putText(self.im,
                            label, (p1[0], p1[1] - 2 if outside else p1[1] + h + 2),
                            #label, (p1[0], p1[1] + 2*h + 10 if outside else p1[1] + 2*h + 10),
                            0,
                            0.9,
                            txt_color,
                            thickness=2,
